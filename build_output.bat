...
"C:\Program Files\Microsoft Visual Studio\2022\Community\MSBuild\Current\Bin\MSBuild.exe" build_output.proj /t:rebuild /p:Configuration=release /p:Platform=x64 /p:VcpkgEnableManifest=true
